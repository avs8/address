...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.primary_email'
        db.add_column(u'userprofile_userprofile', 'primary_email',
                      self.gf('django.db.models.fields.EmailField')(default='/', max_length=50),
                      keep_default=False)

        # Adding field 'UserProfile.phone_number'
        db.add_column(u'userprofile_userprofile', 'phone_number',
                      self.gf('django.db.models.fields.CharField')(default='/', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.primary_email'
        db.delete_column(u'userprofile_userprofile', 'primary_email')

        # Deleting field 'UserProfile.phone_number'
        db.delete_column(u'userprofile_userprofile', 'phone_number')
